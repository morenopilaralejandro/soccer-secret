...
{
    [MenuItem("Tools/Import Data From CSV/Import Teams From CSV")]
    public static void ImportTeamsFromCSV()
    {
        ...
        string tableCollectionName = "TeamNames";
        ...
        int wearIdIndex = System.Array.IndexOf(headers, "wear-id");
        ...
        for (int i = 1; i < lines.Length; i++)
        {
            ...
            teamData.wearId = values[wearIdIndex].Trim();
            ...
            foreach (var locale in locales)
            {
                ...
                table.AddEntry(teamData.teamId, locale.Identifier.Code == "ja" ? teamData.teamNameJa : teamData.teamNameEn);
